...
- look at projects from past years to see what kind of opportunities are available and spark curiosity 
...
`funding_frequency` creates a data visualization based to show how frequently a state has received NIH funding during the selected year. 

```{r}
#funding_frequency(data4)
```
