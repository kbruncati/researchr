...
class(researchr::nih_research(2002))

ncol(researchr::nih_research(1999))  

colnames(researchr::nih_research(1999))[-1] 

researchr::nih_research("a")

researchr::nih_research(1805)
```
